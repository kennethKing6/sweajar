...
import { Grid,Avatar, 
    ...
    Divider, 
    Button,
    List,ListItem ,ListItemButton,ListItemText,ListItemAvatar,Checkbox} from '@mui/material'
        ...
        return (
          ...
          >
            <ListItemButton>
              ...
              <ListItemText id={labelId} primary={`${currentUser.firstName} ${currentUser.lastName}`} />
            </ListItemButton>
          </ListItem>
        );
      })}
